...
func _on_button1_button_up() -> void:
	start_level(song_1_melody_path,song_1_path,song_1_slow_song_path, 76, 8, 29)


func _on_button2_button_up() -> void:
	start_level(song_2_melody_path,song_2_path,song_2_slow_song_path,78, 4, 15)


func _on_button3_button_up() -> void:
	start_level(song_3_melody_path,song_3_song_path,song_3_slow_song_path,106,5, 20)


func _on_button_4_button_up() -> void:
	start_level(song_4_melody_path,song_4_song_path,song_4_slow_song_path,88,5, 20)


func _on_button_5_button_up() -> void:
	start_level(song_5_melody_path,song_5_song_path,song_5_slow_song_path,155,5, 20)
